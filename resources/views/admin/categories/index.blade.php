...
@section('content')
        ...
        <div class="page-header position-fixed">
            <div class="page-header-left d-flex align-items-center">
                <div class="page-header-title">
                    <h5 class="m-b-10">Kategoriyalar</h5>
                </div>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a></li>
                    <li class="breadcrumb-item">Kategoriyalar</li>
                </ul>
            </div>
    ...
    @include('components.admin.categories.news-modal-create')
    @include('components.admin.categories.news-modal-edit')
@endsection
