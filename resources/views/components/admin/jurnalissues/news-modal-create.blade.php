...
<div class="offcanvas offcanvas-end w-50" tabindex="-1" id="tasksDetailsOffcanvas" xmlns="http://www.w3.org/1999/html">
    ...
    <div class="offcanvas-body">
        <form action="{{ route('jurnalissues.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        <label class="form-label">Jurnal soni:</label>
                        <input type="text" name="title" class="form-control" placeholder="masalan: 2026/1-son">
                    </div>
                </div>
