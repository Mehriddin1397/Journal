                ...
                <div class="row g-4">
                    <div class="col-lg-7 col-xl-8 mt-0">
                        ...
                        <div class="border-bottom py-3">
                            <a href="#" class="display-4 text-dark mb-0 link-hover">Jurnalni- {{$category->title}}
                                soni</a>
                        </div>
                                        ...
                                        <div class="article-body">
                                            ...
                                            <p class="article-author">
                                                @foreach($article->authors as $author)
                                                    ✍ Muallif: <span><a
                                                            href="{{ route('author_show', $author->name) }}">{{$author->name}}</a></span>
                                                @endforeach
                                            </p>
                                            <p class="article-author">

                                                Jurnal soni: <span><a
                                                        href="{{ route('journal_show', $article->journalIssue->title) }}">{{$article->journalIssue->title}}</a></span>
